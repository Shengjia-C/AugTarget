        ...
        if img_aug.shape[0]== 3:
            ...
            for i in range(self.target_numbers):
                ...
                if img_aug[0,x[i],y[i]] > 0:
                        ...
                        circle = -circle + np.max((img_aug)[0])
                        ...
                        mask_aug[x[i]:x[i]+hh, y[i]:y[i]+ww] = np.max(mask_aug)
        ...
        if img_aug.shape[0]== 3:
            ...
            for i in range(self.target_numbers):
                ...
                if w[i] < img_aug.shape[1] and h[i] < img_aug.shape[2]:
                    ...
                    x.append(random.randint(0, img_aug.shape[1] - h[i]-5))
                    y.append(random.randint(0, img_aug.shape[2] - w[i]-5))
